...
- (void)initNavgationBar
{
    ...
    UIButton *preViewButton  = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 75, 44)];
...
- (void)initBoardAndEditView
{
    ...
    self.editbutton  = [[UIButton alloc] initWithFrame:CGRectMake(_boardAndEditView.frame.size.width-75-110, 0, 110, 30)];
...
- (void)controlButtonStyleSettingWithButton:(UIButton *)sender
{
    ...
    sender.frame =  CGRectMake((_bottomView.frame.size.width - 200 )/2, 0, 200, _bottomView.frame.size.height);

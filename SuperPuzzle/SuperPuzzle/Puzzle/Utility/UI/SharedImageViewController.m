...
- (void)preViewBtnAction:(id)sender
{
    SUIModalActionSheet *sendSelectSheet = [[SUIModalActionSheet alloc] initWithTitle:nil
                                                               ...
                                                               destructiveButtonTitle:nil
                                                                    otherButtonTitles:@"Save the photo album",
                                            @"back", nil];
...
-(void) saveTapHandler{
    [[LoadingViewManager sharedInstance] showText:@"Is to save" inView:self.view];
...
- (void)imageSavedToPhotosAlbum:(UIImage *)image didFinishSavingWithError:(NSError *)error contextInfo:(void *) contextInfo {
    ...
    if (!error) {
        ...
        message = @"Successfully saved to the photo album";
    } else {
        title = @"failure";
